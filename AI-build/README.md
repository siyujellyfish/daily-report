...
- Phase 5 — Production hardening & launch：下一階段。最終 `INGEST_SECRET` 輪替後，才把 Phase 4 驗證過的 delivery contract 套到兩個正式 recurring Tasks 並觀察第一輪 unattended Production execution。
